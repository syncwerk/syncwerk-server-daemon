...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), SYNCWERK_TYPE_PUTCOMMIT_V3_PROC, SyncwerkPutcommitProcPriv))
...
G_DEFINE_TYPE (SyncwerkPutcommitV3Proc, syncwerk_putcommit_v3_proc, CCNET_TYPE_PROCESSOR)
...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS (syncwerk_putcommit_v3_proc_parent_class)->release_resource (processor);
}

static void
syncwerk_putcommit_v3_proc_class_init (SyncwerkPutcommitV3ProcClass *klass)
{
...
static void
syncwerk_putcommit_v3_proc_init (SyncwerkPutcommitV3Proc *processor)
{
}
