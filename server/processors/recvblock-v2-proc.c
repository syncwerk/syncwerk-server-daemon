...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), SYNCWERK_TYPE_RECVBLOCK_V2_PROC, BlockProcPriv))
...
G_DEFINE_TYPE (SyncwerkRecvblockV2Proc, syncwerk_recvblock_v2_proc, CCNET_TYPE_PROCESSOR)

#define RECVBLOCK_PROC
#include "processors/blocktx-common-impl-v2.h"

static void
syncwerk_recvblock_v2_proc_class_init (SyncwerkRecvblockV2ProcClass *klass)
{
...
static void
syncwerk_recvblock_v2_proc_init (SyncwerkRecvblockV2Proc *processor)
{
}
...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS(syncwerk_recvblock_v2_proc_parent_class)->release_resource (processor);
}
