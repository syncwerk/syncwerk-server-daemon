...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), SYNCWERK_TYPE_RECVCOMMIT_V2_PROC, RecvcommitPriv))
...
G_DEFINE_TYPE (SyncwerkRecvcommitV2Proc, syncwerk_recvcommit_v2_proc, CCNET_TYPE_PROCESSOR)
...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS (syncwerk_recvcommit_v2_proc_parent_class)->release_resource (processor);
}

static void
syncwerk_recvcommit_v2_proc_class_init (SyncwerkRecvcommitV2ProcClass *klass)
{
...
static void
syncwerk_recvcommit_v2_proc_init (SyncwerkRecvcommitV2Proc *processor)
{
}
