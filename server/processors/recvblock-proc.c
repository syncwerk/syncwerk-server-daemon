...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), SYNCWERK_TYPE_RECVBLOCK_PROC, BlockProcPriv))
...
G_DEFINE_TYPE (SyncwerkRecvblockProc, syncwerk_recvblock_proc, CCNET_TYPE_PROCESSOR)

static void
syncwerk_recvblock_proc_class_init (SyncwerkRecvblockProcClass *klass)
{
...
static void
syncwerk_recvblock_proc_init (SyncwerkRecvblockProc *processor)
{
}
