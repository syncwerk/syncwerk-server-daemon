...
GList *
syncw_repo_diff (SyncwRepo *repo, const char *arg1, const char *arg2, int fold_dir_results, char **error);
 ...
 * @params: same as syncw_repo_manager_post_file
