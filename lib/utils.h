...
#define SyncwStat struct __stat64
...
int syncw_stat (const char *path, SyncwStat *st);
int syncw_fstat (int fd, SyncwStat *st);
...
int syncw_set_file_time (const char *path, guint64 mtime);
