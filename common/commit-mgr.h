...
#ifndef SYNCW_COMMIT_MGR_H
#define SYNCW_COMMIT_MGR_H

struct _SyncwCommitManager;
typedef struct _SyncwCommit SyncwCommit;
...
struct _SyncwCommit {
    struct _SyncwCommitManager *manager;
...
*/
typedef gboolean (*CommitTraverseFunc) (SyncwCommit *commit, void *data, gboolean *stop);

struct _SyncwerkSession;

typedef struct _SyncwCommitManager SyncwCommitManager;
typedef struct _SyncwCommitManagerPriv SyncwCommitManagerPriv;
...
struct _SyncwCommitManager {
    ...
    SyncwCommitManagerPriv *priv;
};

SyncwCommitManager *
syncw_commit_manager_new (struct _SyncwerkSession *syncw);
 ...
 */
int
syncw_commit_manager_add_commit (SyncwCommitManager *mgr, SyncwCommit *commit);
...
/**
 * Works the same as syncw_commit_manager_traverse_commit_tree, but stops
