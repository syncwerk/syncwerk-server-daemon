...
from objectstorage.objstore_factory import SyncwObjStoreFactory
...
def main():
    try:
        fs_obj_factory = SyncwObjStoreFactory()
        os.environ['SYNCWERK_CENTRAL_CONF_DIR'] = os.environ['CEPH_SYNCWERK_CENTRAL_CONF_DIR']
    except KeyError:
        logging.warning('CEPH_SYNCWERK_CENTRAL_CONF_DIR environment variable is not set.\n')
        sys.exit()

    ceph_obj_factory = SyncwObjStoreFactory()
