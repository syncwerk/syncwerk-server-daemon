...
def get_syncwerk_mysql_info():
    syncwerk_conf = os.path.join(env_mgr.syncwerk_dir, 'server.conf')
    defaults = {
        'HOST': '127.0.0.1',
        'PORT': '3306',
    }
...
def get_syncwerk_db_infos():
    ccnet_db_info = get_ccnet_mysql_info()
    syncwerk_db_info = get_syncwerk_mysql_info()
    restapi_db_info = get_restapi_mysql_info()

    infos = [ccnet_db_info, syncwerk_db_info, restapi_db_info]
