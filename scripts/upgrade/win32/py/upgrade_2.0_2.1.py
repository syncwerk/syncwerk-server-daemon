...
from upgrade_common import install_path, syncwerk_dir, upgrade_db

def copy_template_library():
    src_docs_dir = os.path.join(install_path, 'syncwerk', 'docs')
    library_template_dir= os.path.join(syncwerk_dir, 'template')
