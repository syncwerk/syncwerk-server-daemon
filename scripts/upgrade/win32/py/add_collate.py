...
'''
Database Upgrade scripts for syncwerk windows server 2.0.2
'''
...
from upgrade_common import syncwserv_dir, ccnet_dir, syncwerk_dir

# syncwserv_dir = '/tmp/syncwerk'
...
class SyncwerkDBUpdater(AbstractDBUpdater):
    name = 'syncwerk database'
    patterns = [
    ...
    def __init__(self, syncwerk_db):
        AbstractDBUpdater.__init__(self, syncwerk_db)

class RestapiDBUpdater(AbstractDBUpdater):
    name = 'restapi database'
    patterns = [
    ...
    def __init__(self, restapi_db):
        AbstractDBUpdater.__init__(self, restapi_db)
...
def upgrade_collate():
    ...
    updaters = [
        ...
        SyncwerkDBUpdater(syncwerk_db),
        RestapiDBUpdater(restapi_db),
    ]
