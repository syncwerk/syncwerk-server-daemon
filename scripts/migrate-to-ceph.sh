...
migrate_to_ceph=${INSTALLPATH}/objectstorage_migrate.py

script_name=$0
function usage () {
    echo "usage : "
    echo "$(basename ${script_name}) ceph_syncwerk_central_conf_dir"
    echo ""
}
...
function do_migrate_to_ceph () {
    ...
    export SYNCWERK_CONF_DIR=${default_syncwerk_data_dir}
    export SYNCWERK_CENTRAL_CONF_DIR=${default_conf_dir}
    export CEPH_SYNCWERK_CENTRAL_CONF_DIR=${ceph_syncwerk_central_conf_dir}
...
ceph_syncwerk_central_conf_dir="$1"
do_migrate_to_ceph;
